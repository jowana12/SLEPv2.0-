...
<html lang="en">
    ...
    ?>
        ...
        <?php
            ...
            echo "
                 <div class='title'>
                 <h1 class='title-header' style='font-size: 30px;'>".$row['organization_name']."</h1>
                 <hr style='border-top: 3px solid #ffd028;'>
                </div>
            ";
        ?>
            ...
            <?php
                ...
                ";
            ?>
                <button class='btn-register'>Membership Approval</button></a>
            </div>
